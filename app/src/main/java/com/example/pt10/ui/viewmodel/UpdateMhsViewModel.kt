...
import com.example.pt10.ui.navigation.DestinasiUpdate
...
class UpdateMhsViewModel(
    ...
    fun validateFields() : Boolean{
        ...
        val errorState = FormErrorState(
            ...
            jenisKelamin = if (event.jenisKelamin.isNotEmpty()) null else "Jenis Kelamin tidak boleh sama",
            alamat = if (event.alamat.isNotEmpty()) null else "Alamat tisak boleh kosong",
